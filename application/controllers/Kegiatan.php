...
class Kegiatan extends MX_Controller
{
    ...
    public function pramuka()
    {
        ...
        $this->template->load('templates/template', 'prodi/pramuka', $data);
    }
    public function kir()
    {
        ...
        $this->template->load('templates/template', 'prodi/kir', $data);
    }
    public function rohis()
    {
        ...
        $this->template->load('templates/template', 'prodi/rohis', $data);
    }
    public function teko()
    {
        ...
        $this->template->load('templates/template', 'prodi/teko', $data);
    }
    public function pmr()
    {
        ...
        $this->template->load('templates/template', 'prodi/pmr', $data);
    }
    public function gps()
    {
        ...
        $this->template->load('templates/template', 'prodi/gps', $data);
    }
    public function paskibra()
    {
        ...
        $this->template->load('templates/template', 'prodi/paskibra', $data);
    }
    public function futsal()
    {
        ...
        $data['header'] = "Futsal";
        $this->template->load('templates/template', 'prodi/futsal', $data);
    }
    public function taekwondo()
    {
        ...
        $this->template->load('templates/template', 'prodi/taekwondo', $data);
    }
    public function silat()
    {
        ...
        $this->template->load('templates/template', 'prodi/silat', $data);
    }
}
